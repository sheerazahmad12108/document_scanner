...
class FavoritePDFAdapter : RecyclerView.Adapter<FavoritePDFAdapter.FavoritePDFViewHolder>() {
    ...
    inner class FavoritePDFViewHolder(view: View) : RecyclerView.ViewHolder(view) {
